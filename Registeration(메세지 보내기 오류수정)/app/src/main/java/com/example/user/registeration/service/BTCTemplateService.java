...
package com.example.user.registeration.service;
...
import com.example.user.registeration.MainActivity;
import com.example.user.registeration.bluetooth.BluetoothManager;
import com.example.user.registeration.bluetooth.ConnectionInfo;
import com.example.user.registeration.bluetooth.TransactionBuilder;
import com.example.user.registeration.bluetooth.TransactionReceiver;
import com.example.user.registeration.contents.CommandParser;
import com.example.user.registeration.http.HttpInterface;
import com.example.user.registeration.http.HttpListener;
import com.example.user.registeration.utils.AppSettings;
...
public class BTCTemplateService extends Service {
	...
	public void onCreate() {
		Logs.e(TAG, "# Service - onCreate() starts here");
			...
			// Received packets from remote
				case BluetoothManager.MESSAGE_READ:
					...
					if(msg.arg1 > 0) {
						...
						String pn = MainActivity.returnNumber();


						mActivityHandler.obtainMessage(Constants.MESSAGE_READ_CHAT_DATA, strMsg)
								.sendToTarget();
						Toast.makeText(getApplicationContext(),
								"위급상황", Toast.LENGTH_SHORT).show();
						sendSMS(pn,"위급한 상황입니다.");
